"""
Test script - follows GettingStarted_v2.ipynb structure exactly.
Usage: py test_solution.py
"""
import sys
...
# ============================================================
# Cell 2: pip install (handled externally, not in script)
# ============================================================
...
# ============================================================
# Cell 4: class Solution (from Submission_v2.ipynb)
# ============================================================
import re
...
# ============================================================
# Cell 5: Load test data (local paths instead of gdown)
# ============================================================
# (no download needed - using local files in v2_2_level_address/)

# ============================================================
# Cell 6: Scoring (exact copy from GettingStarted_v2.ipynb)
# ============================================================
...
with open(r'v2_2_level_address\public.json', encoding='utf-8') as f:
    data = json.load(f)
